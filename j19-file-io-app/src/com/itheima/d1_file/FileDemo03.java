...
public class FileDemo03 {
    public static void main(String[] args) throws IOException {
        ...
        /*
         b.mkdir创建一级目录
         */
        File f2 = new File("D:/jpg/aaa");
        System.out.println(f2.mkdir());

        // c.mkdirs创建多级目录(重点)
        File f3 = new File("D:/jpg/aaa/ccc/ddd/eee/ffff");
//        System.out.println(f3.mkdir());
        System.out.println(f3.mkdirs()); // 支持多级创建

        // d.删除文件或者空文件夹
        System.out.println(f1.delete());
        File f4 = new File("D:/jpg/cat01-copia.jpg");
        System.out.println(f4.delete()); // 占用一样可以删除

        // 只能删除空文件夹,不能删除非空文件夹. delete方法直接删除不走回收站
        File f5 = new File("D:/jpg/aaa");
